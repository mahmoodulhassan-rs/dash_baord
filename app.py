...
fig = px.pie(df_grp_dash, values='Numbers', names='Category',color = "Category", title='Regression ran on'+datetime.datetime.now().strftime('%Y-%m-%d'), color_discrete_map={'Tests Passed':'#66CDAA',
