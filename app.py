...
arr =[400,400,400,400,400,400,400,400,400,400,400,439,647,633,663,660,662,663]
aarr= [21,35,39,56,65,96,139,167,171,195,360,379,600,588,639,616,646,629]
arr_f= [0,3,3,0,4,15,39,37,30,50,50,37,27,25,10,36,8,23]
    ...
    figure = fig_test,
        ...
        html.Div([
               html.H6(children = 'Regression Date',
                ...
                html.P('db9785668bee87df0a59ca01ca60af1563139c7a',
                       style={'textAlign': 'center',
                              'color': '#00008B',
                              'fontSize': 15,
                              'margin-top': '-10px'
