...
arr =[400,400,400,400,400,400,400,400,400,400,400,439,647,633,663,660]
aarr= [21,35,39,56,65,96,139,167,171,195,360,379,600,588,639,605]
arr_f= [0,3,3,0,4,15,39,37,30,50,50,37,27,25,10,40]
...
'''),
 dcc.Markdown('''
    [](/)
'''),
 html.Div(children = "SHA: 236cdf75feed51f3e8df310529f7872d9bd40038", style = {
     'textAlign': 'left',
     'color': 'Black',
     'fontWeight': 'bold'
   }),
