...
arr =[158,158,158,158,158,158,250,250,250,250,420,439,647,633,663,660]
aarr= [21,35,39,56,65,96,139,167,171,195,360,379,600,588,639,607]
arr_f= [0,3,3,0,4,15,39,37,30,50,50,37,27,25,10,37]
...
'''),
 dcc.Markdown('''
    [](/)
'''),
 html.Div(children = "SHA: e1fd5595e4f68d08a03961806b6b2317989e1b99", style = {
     'textAlign': 'left',
     'color': 'Black',
     'fontWeight': 'bold'
   }),
